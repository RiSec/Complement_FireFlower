    ...
    return (
        <>
            ...
            <head>
                ...
                <link href="https://fonts.googleapis.com/css2?family=Chokokutai&family=Reggae+One&family=Yuji+Hentaigana+Akebono&display=swap" rel="stylesheet"></link>


                <link rel="preconnect" href="https://fonts.googleapis.com"></link>
                <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin></link>
                <link href="https://fonts.googleapis.com/css2?family=Chokokutai&family=Reggae+One&display=swap" rel="stylesheet"></link>
                <title>uppun bakuhatu</title>
            </head>
            <body>
                <img id="mypic-1" class="mypic-1" src="/img/hanabi-1.png" width="400" height="300"></img>
                <img id="mypic-2" class="mypic-2" src="/img-2/hanabi-1.png" width="400" height="300"></img>
                <header>
                ...
                <main>
                    ...
                    <div class="flex-2">
                        <p class="attention">お使いの端末は非推奨です。フォントが崩れる場合があります。</p>
                    </div>
                ...
                <aside>
                    ...
                    <nav>
                        <div class="go-explostion" id="wrapper"><Link to="/UploadPage">打ち上げる</Link></div>
                    </nav>

                    <div class="score" id="wrapper"><a href="../score/index.html">過去のスコア</a></div>
                </aside>
