...
export default function ReductionWidth({ minTarget, minWidth, maxTarget, maxWidth, volume }) {
    ...
    setTimeout(function () {
        ...
        var ReduceintervalID = setInterval(
            function () {
                minChangeWidth()
            },
            1
        ...
        function maxChangeWidth() {
            var ExpentionIntervalID = setInterval(
                function () {
                    ...
                    if (width < maxWidth) {
                        ...
                        setTimeout(function () { navigate("/UploadPage/ImageRecievege/FireworksPage", { state: { volume: { volume } } }) }, 4000);
                        //  fire();
